# Mate2QA — WMS 상품그룹재고 항목설정 JSON 저장·적용 (런처 7번 서브 421·422)
...
SETTINGS_FILE_STOCK_PRODUCT_GROUP = (
    PROJECT_DIR / "grid_item_settings_stock_product_group.json"
)
SCREEN_NAME = "상품그룹재고"

CONFIG = {
    **_BASE_CONFIG,
    "item_settings_file": SETTINGS_FILE_STOCK_PRODUCT_GROUP.name,
    "stock_item_action": ACTION_SAVE,
    "stock_item_screen_name": SCREEN_NAME,
    "stock_item_screen_key": "stock_product_group",
    "stock_item_url_key": "sach_prod_grp_stock_list_url",
    "stock_item_save_menu_no": "421",
}


def run_task(page, context, config=None, *, keep_browser: bool = False):
    """421(save) 또는 422(apply) 항목설정 작업을 실행합니다."""
