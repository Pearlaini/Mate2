# Mate2QA — WMS 로케이션재고 항목설정 JSON 저장·적용 (런처 7번 서브 431·432)
...
SETTINGS_FILE_STOCK_LOCATION = PROJECT_DIR / "grid_item_settings_stock_location.json"
SCREEN_NAME = "로케이션재고"

CONFIG = {
    **_BASE_CONFIG,
    "item_settings_file": SETTINGS_FILE_STOCK_LOCATION.name,
    "stock_item_action": ACTION_SAVE,
    "stock_item_screen_name": SCREEN_NAME,
    "stock_item_screen_key": "stock_location",
    "stock_item_url_key": "sach_stock_list_url",
    "stock_item_save_menu_no": "431",
}


def run_task(page, context, config=None, *, keep_browser: bool = False):
    """431(save) 또는 432(apply) 항목설정 작업을 실행합니다."""
